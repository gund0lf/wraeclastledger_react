...
if (existsSync(stableMetadataPath)) fail('stable latest-linux.yml was generated by a prerelease build');
...
if (packagedChannel !== channel) {
  fail(`${packagedUpdaterConfigPath} uses ${packagedChannel ?? 'no channel'}, expected ${channel}`);
}
