...
export const BRICK_MOD_DEFS: BrickModDef[] = [
  ...
  { id: 'brick_max_res_regular', label: 'Reduced Max Resistances', summaryLabel: 'Max Res -12 to -9%', affixLines: ['Players have -12–-9% to all maximum Resistances'], tradePatterns: [{ text: "Players have #% to all maximum Resistances", statId: 'explicit.stat_3376488707', value: { min: -12, max: -9 } }], category: 'regular', familyId: 'maximum_resistances' },
  ...
  { id: 'brick_crit_regular', label: 'High Crit Chance + Multiplier', summaryLabel: 'Crit Multi 41–45%', affixLines: ['Monsters have 360–400% increased Critical Strike Chance', '+41–45% to Monster Critical Strike Multiplier'], tradePatterns: [{ text: "+#% to Monster Critical Strike Multiplier", statId: 'explicit.stat_57326096', value: { min: 41, max: 45 } }], category: 'regular', familyId: 'critical_multiplier' },
  { id: 'extra_chaos_damage_withered', label: 'Extra Chaos Damage + Withered', affixLines: ['Monsters gain #% of their Physical Damage as Extra Chaos Damage', 'Monsters Inflict Withered for 2 seconds on Hit'], tradePatterns: [{ text: "Monsters gain #% of their Physical Damage as Extra Chaos Damage" }], category: 'regular' },
  ...
  { id: 'boss_damage_attack_speed', label: 'Boss Damage + Attack Speed', affixLines: ['Unique Boss deals 25% increased Damage', 'Unique Boss has 30% increased Attack and Cast Speed'], tradePatterns: [{ text: "Unique Boss deals #% increased Damage" }], category: 'regular' },
  { id: 'monster_speed_move_attack_cast', label: 'Monster Speed (Move/Attack/Cast)', affixLines: ['25–30% increased Monster Movement Speed', '35–45% increased Monster Attack Speed', '35–45% increased Monster Cast Speed'], tradePatterns: [{ text: "#% increased Monster Movement Speed" }], category: 'regular' },
  { id: 'boss_more_life_aoe', label: 'Boss More Life + AoE', affixLines: ['Unique Boss has 35% increased Life', 'Unique Boss has 70% increased Area of Effect'], tradePatterns: [{ text: "Unique Boss has #% increased Life" }], category: 'regular' },
  ...
  { id: 'brick_monster_damage_regular', label: 'Increased Monster Damage', summaryLabel: 'Monster Dmg 22–25%', affixLines: ['22–25% increased Monster Damage'], tradePatterns: [{ text: "#% increased Monster Damage", statId: 'explicit.stat_1890519597', value: { min: 22, max: 25 } }], category: 'regular', familyId: 'monster_damage' },
  { id: 'players_less_suppressed_spell_damage', label: 'Players Less Suppressed Spell Damage', affixLines: ['Monsters have 50% increased Accuracy Rating', 'Players have -20% to amount of Suppressed Spell Damage Prevented'], tradePatterns: [{ text: "Players Prevent +#% of Suppressed Spell Damage" }], category: 'regular' },
  { id: 'monsters_increased_accuracy_rating', label: 'Monsters Increased Accuracy Rating', affixLines: ['Monsters have 50% increased Accuracy Rating', 'Players have -20% to amount of Suppressed Spell Damage Prevented'], tradePatterns: [{ text: "Monsters have #% increased Accuracy Rating" }], category: 'regular' },
  { id: 'brick_suppression_regular', label: 'Monsters Suppress Spell Damage Chance', summaryLabel: 'Suppression 60%', affixLines: ['Monsters have +60% chance to Suppress Spell Damage'], tradePatterns: [{ text: "Monsters have +#% chance to Suppress Spell Damage", statId: 'explicit.stat_2138205941', value: { min: 60, max: 60 } }], category: 'regular', familyId: 'spell_suppression' },
  ...
  { id: 'reduced_block_less_armour', label: 'Reduced Block + Less Armour', affixLines: ['Players have 30% less Armour', 'Players have 40% reduced Chance to Block'], tradePatterns: [{ text: "Players have #% reduced Chance to Block" }], category: 'regular' },
  ...
  { id: 'brick_es_regular', label: 'Extra Energy Shield from Life', summaryLabel: 'Life to ES 40–49%', affixLines: ['Monsters gain 40–49% of Maximum Life as Extra Maximum Energy Shield'], tradePatterns: [{ text: "Monsters gain #% of Maximum Life as Extra Maximum Energy Shield", statId: 'explicit.stat_2887760183', value: { min: 40, max: 49 } }], category: 'regular', familyId: 'energy_shield_from_life' },
  ...
  { id: 'brick_armoured_regular', label: 'Armoured', affixLines: ['+40% Monster Physical Damage Reduction'], tradePatterns: [{ text: "+#% Monster Physical Damage Reduction", statId: 'explicit.stat_839186746', value: { min: 40, max: 40 } }], category: 'regular', familyId: 'monster_protection' },
  ...
  { id: 'brick_resistant_regular', label: 'Resistant', affixLines: ['+25% Monster Chaos Resistance', '+40% Monster Elemental Resistances'], tradePatterns: [{ text: "+#% Monster Chaos Resistance", statId: 'explicit.stat_365540634', value: { min: 25, max: 25 } }], category: 'regular', familyId: 'monster_protection' },
  { id: 'brick_monster_life_low_regular', label: 'Unwavering — More Monster Life', summaryLabel: 'More Life 25–30%', affixLines: ['25–30% more Monster Life', 'Monsters cannot be Stunned'], tradePatterns: [{ text: "#% more Monster Life", statId: "explicit.stat_95249895", value: { min: 25, max: 30 } }], category: 'regular', familyId: 'monster_life' },
  { id: 'brick_monster_life_regular', label: 'Fecund — More Monster Life', summaryLabel: 'More Life 40–49%', affixLines: ['40–49% more Monster Life'], tradePatterns: [{ text: "#% more Monster Life", statId: "explicit.stat_95249895", value: { min: 40, max: 49 } }], category: 'regular', familyId: 'monster_life' },
  ...
  { id: 'brick_buff_expiry_regular', label: 'Buffs on Players Expire Faster', summaryLabel: 'Buff Expiry 70%', affixLines: ['Buffs on Players expire 70% faster'], tradePatterns: [{ text: "Buffs on Players expire #% faster", statId: 'explicit.stat_1217583941', value: { min: 70, max: 70 } }], category: 'regular', familyId: 'buff_expiry' },
  ...
  { id: 'cannot_be_taunted_slowed', label: 'Cannot Be Taunted/Slowed', affixLines: ['Monsters cannot be Taunted', "Monsters' Action Speed cannot be modified to below Base Value", "Monsters' Movement Speed cannot be modified to below Base Value"], tradePatterns: [{ text: "Monsters cannot be Taunted" }], category: 'regular' },
  ...
  { id: 'brick_crit_nightmare', label: 'High Crit Chance + Multiplier', summaryLabel: 'Crit Multi 70–75%', affixLines: ['Monsters have 650–700% increased Critical Strike Chance', '+70–75% to Monster Critical Strike Multiplier'], tradePatterns: [{ text: "+#% to Monster Critical Strike Multiplier", statId: 'explicit.stat_57326096', value: { min: 70, max: 75 } }], category: 'nightmare', familyId: 'critical_multiplier' },
  { id: 'brick_es_nightmare', label: 'Extra Energy Shield from Life', summaryLabel: 'Life to ES 70–80%', affixLines: ['Monsters gain 70–80% of Maximum Life as Extra Maximum Energy Shield'], tradePatterns: [{ text: "Monsters gain #% of Maximum Life as Extra Maximum Energy Shield", statId: 'explicit.stat_2887760183', value: { min: 70, max: 80 } }], category: 'nightmare', familyId: 'energy_shield_from_life' },
  ...
  { id: 'brick_max_res_nightmare', label: '-20% Max Resistances', summaryLabel: 'Max Res -20%', affixLines: ['Players have -20% to all maximum Resistances'], tradePatterns: [{ text: "Players have #% to all maximum Resistances", statId: 'explicit.stat_3376488707', value: { min: -20, max: -20 } }], category: 'nightmare', familyId: 'maximum_resistances' },
  { id: 'brick_monster_damage_nightmare', label: 'Increased Monster Damage', summaryLabel: 'Monster Dmg 30–40%', affixLines: ['30–40% increased Monster Damage'], tradePatterns: [{ text: "#% increased Monster Damage", statId: 'explicit.stat_1890519597', value: { min: 30, max: 40 } }], category: 'nightmare', familyId: 'monster_damage' },
  { id: 'brick_monster_life_nightmare', label: 'Fecund — More Monster Life', summaryLabel: 'More Life 90–100%', affixLines: ['90–100% more Monster Life'], tradePatterns: [{ text: "#% more Monster Life", statId: 'explicit.stat_95249895', value: { min: 90, max: 100 } }], category: 'nightmare', familyId: 'monster_life' },
  { id: 'brick_suppression_nightmare', label: 'Monsters Suppress Spell Damage Chance', summaryLabel: 'Suppression 100%', affixLines: ['Monsters have +100% chance to Suppress Spell Damage'], tradePatterns: [{ text: "Monsters have +#% chance to Suppress Spell Damage", statId: 'explicit.stat_2138205941', value: { min: 100, max: 100 } }], category: 'nightmare', familyId: 'spell_suppression' },
  { id: 'brick_buff_expiry_nightmare', label: 'Buffs on Players Expire Faster', summaryLabel: 'Buff Expiry 100%', affixLines: ['Buffs on Players expire 100% faster'], tradePatterns: [{ text: "Buffs on Players expire #% faster", statId: 'explicit.stat_1217583941', value: { min: 100, max: 100 } }], category: 'nightmare', familyId: 'buff_expiry' },
  ...
  { id: 'uber_frenzy_charge_max_frenzy', label: 'Frenzy Charge + Max Frenzy', affixLines: ['Monsters have +1 to Maximum Frenzy Charges', 'Monsters gain a Frenzy Charge on Hit'], tradePatterns: [{ text: "Monsters have +# to Maximum Frenzy Charges" }], category: 'nightmare' },
  ...
  { id: 'uber_skills_chain_terrain_chain', label: 'Skills Chain + Terrain Chain', affixLines: ["Monsters' skills Chain 3 additional times", "Monsters' Projectiles have 100% chance to be able to Chain when colliding with Terrain"], tradePatterns: [{ text: "Monsters' Projectiles have #% chance to be able to Chain when colliding with Terrain" }], category: 'nightmare' },
  ...
  { id: 'brick_protected_nightmare', label: 'Protected', affixLines: ['+50% Monster Physical Damage Reduction', '+35% Monster Chaos Resistance', '+55% Monster Elemental Resistances'], tradePatterns: [{ text: "+#% Monster Physical Damage Reduction", statId: 'explicit.stat_839186746', value: { min: 50, max: 50 } }], category: 'nightmare', familyId: 'monster_protection' },
  // FIXED: 'll dam' was wrong ('All Monster Damage' has 'll M' not 'll D'). 'n ig' from 'can Ignite' — aligns with uber token.
  { id: 'uber_all_damage_can_ignite_freeze_shock', label: 'All Damage Can Ignite/Freeze/Shock', affixLines: ['All Monster Damage can Ignite, Freeze and Shock', 'Monsters Ignite, Freeze and Shock on Hit'], tradePatterns: [{ text: "All Monster Damage can Ignite, Freeze and Shock" }], category: 'nightmare' },
  ...
  { id: 'uber_endurance_charges_max_endurance', label: 'Endurance Charges + Max Endurance', affixLines: ['Monsters have +1 to Maximum Endurance Charges', 'Monsters gain an Endurance Charge when hit'], tradePatterns: [{ text: "Monsters have +# to Maximum Endurance Charges" }], category: 'nightmare' },
  ...
  { id: 'uber_triple_curse_vuln_temporal_elem', label: 'Triple Curse (Vuln/Temporal/Elem)', affixLines: ['Players are Cursed with Vulnerability', 'Players are Cursed with Temporal Chains', 'Players are Cursed with Elemental Weakness'], tradePatterns: [{ text: "Players are Cursed with Temporal Chains", statId: 'explicit.stat_2326202293' }], category: 'nightmare' },
  // Juggernaut owns the one-line Action Speed stat. The two-line Action +
  // Movement stat belongs to Unstoppable and is represented by the regular
  // Cannot Be Taunted/Slowed row above.
  { id: 'uber_stunned_action_move_speed_floor', label: 'Juggernaut — Cannot Be Stunned + Action Speed Floor', affixLines: ['Monsters cannot be Stunned', "Monsters' Action Speed cannot be modified to below Base Value"], tradePatterns: [{ text: "Monsters' Action Speed cannot be modified to below Base Value", statId: 'explicit.stat_2758454849' }], category: 'nightmare' },
  ...
  { id: 'uber_poison_duration_all_can_poison', label: 'Poison + Duration + All Can Poison', affixLines: ['Monsters Poison on Hit', "All Damage from Monsters' Hits can Poison", 'Monsters have 100% increased Poison Duration'], tradePatterns: [{ text: "Monsters have #% increased Poison Duration" }], category: 'nightmare' },
  ...
  { id: 'uber_power_charges_max_power', label: 'Power Charges + Max Power', affixLines: ['Monsters have +1 to Maximum Power Charges', 'Monsters gain a Power Charge on Hit'], tradePatterns: [{ text: "Monsters have +# to Maximum Power Charges" }], category: 'nightmare' },
...
const LEGACY_LINKED_TOKEN_TARGETS: Readonly<Record<string, readonly ModTokenId[]>> = {
  // Pre-fix Endurance-gain catalogue token. Its UI meaning was always the gain
  // mechanic, even though the substring also caught steal-charges in stash.
  ndur: ['monsters_gain_endurance_charges'],
