...
export const BRICK_MOD_DEFS: BrickModDef[] = [
  // ── Regular ──
  { id: 'brick_thorns_physical_regular', label: 'Physical Thorns', displayText: 'Rare Monsters have Physical Thorns reflecting 800 Physical Damage', tradePatterns: [{ text: "Rare Monsters have Physical Thorns reflecting # Physical Damage", statId: 'explicit.stat_3278889477', value: { min: 800, max: 800 } }], category: 'regular', familyId: 'thorns' },
  { id: 'brick_thorns_elemental_regular', label: 'Elemental Thorns', displayText: 'Rare Monsters have Elemental Thorns reflecting 1500 Elemental Damage', tradePatterns: [{ text: "Rare Monsters have Elemental Thorns reflecting # Elemental Damage", statId: 'explicit.stat_3938822425', value: { min: 1500, max: 1500 } }], category: 'regular', familyId: 'thorns' },
  ...
  { id: 'brick_max_res_regular', label: 'Reduced Max Resistances', displayText: 'Players have -12–-9% to all maximum Resistances', tradePatterns: [{ text: "Players have #% to all maximum Resistances", statId: 'explicit.stat_3376488707', value: { min: -12, max: -9 } }], category: 'regular', familyId: 'maximum_resistances' },
  ...
  { id: 'brick_crit_regular', label: 'High Crit Chance + Multiplier', displayText: '+41–45% to Monster Critical Strike Multiplier', tradePatterns: [{ text: "+#% to Monster Critical Strike Multiplier", statId: 'explicit.stat_57326096', value: { min: 41, max: 45 } }], category: 'regular', familyId: 'critical_multiplier' },
  ...
  { id: 'brick_monster_damage_regular', label: 'Increased Monster Damage', displayText: '22–25% increased Monster Damage', tradePatterns: [{ text: "#% increased Monster Damage", statId: 'explicit.stat_1890519597', value: { min: 22, max: 25 } }], category: 'regular', familyId: 'monster_damage' },
  ...
  { id: 'brick_suppression_regular', label: 'Monsters Suppress Spell Damage Chance', displayText: 'Monsters have +60% chance to Suppress Spell Damage', tradePatterns: [{ text: "Monsters have +#% chance to Suppress Spell Damage", statId: 'explicit.stat_2138205941', value: { min: 60, max: 60 } }], category: 'regular', familyId: 'spell_suppression' },
  ...
  { id: 'brick_monster_life_low_regular', label: 'Unwavering — More Monster Life', displayText: '25–30% more Monster Life', tradePatterns: [{ text: "#% more Monster Life", statId: "explicit.stat_95249895", value: { min: 25, max: 30 } }], category: 'regular', familyId: 'monster_life' },
  { id: 'brick_monster_life_regular', label: 'Fecund — More Monster Life', displayText: '40–49% more Monster Life', tradePatterns: [{ text: "#% more Monster Life", statId: "explicit.stat_95249895", value: { min: 40, max: 49 } }], category: 'regular', familyId: 'monster_life' },
  ...
  { id: 'brick_buff_expiry_regular', label: 'Buffs on Players Expire Faster', displayText: 'Buffs on Players expire 70% faster', tradePatterns: [{ text: "Buffs on Players expire #% faster", statId: 'explicit.stat_1217583941', value: { min: 70, max: 70 } }], category: 'regular', familyId: 'buff_expiry' },
  ...
  // ── Nightmare ──
  { id: 'brick_thorns_combined_nightmare', label: 'Thorns Reflection', displayText: 'Rare Monsters have Physical Thorns reflecting 1500 Physical Damage / Rare Monsters have Elemental Thorns reflecting 2500 Elemental Damage', tradePatterns: [{ text: "Rare Monsters have Elemental Thorns reflecting # Elemental Damage", statId: 'explicit.stat_3938822425', value: { min: 2500, max: 2500 } }], category: 'nightmare', familyId: 'thorns' },
  { id: 'brick_crit_nightmare', label: 'High Crit Chance + Multiplier', displayText: '+70–75% to Monster Critical Strike Multiplier', tradePatterns: [{ text: "+#% to Monster Critical Strike Multiplier", statId: 'explicit.stat_57326096', value: { min: 70, max: 75 } }], category: 'nightmare', familyId: 'critical_multiplier' },
  { id: 'brick_es_nightmare', label: 'Extra Energy Shield from Life', displayText: 'Monsters gain 70–80% of Maximum Life as Extra Maximum Energy Shield', tradePatterns: [{ text: "Monsters gain #% of Maximum Life as Extra Maximum Energy Shield", statId: 'explicit.stat_2887760183', value: { min: 70, max: 80 } }], category: 'nightmare', familyId: 'energy_shield_from_life' },
  ...
  { id: 'brick_max_res_nightmare', label: '-20% Max Resistances', displayText: 'Players have -20% to all maximum Resistances', tradePatterns: [{ text: "Players have #% to all maximum Resistances", statId: 'explicit.stat_3376488707', value: { min: -20, max: -20 } }], category: 'nightmare', familyId: 'maximum_resistances' },
  { id: 'brick_monster_damage_nightmare', label: 'Increased Monster Damage', displayText: '30–40% increased Monster Damage', tradePatterns: [{ text: "#% increased Monster Damage", statId: 'explicit.stat_1890519597', value: { min: 30, max: 40 } }], category: 'nightmare', familyId: 'monster_damage' },
  { id: 'brick_monster_life_nightmare', label: 'Oppressive — More Monster Life', displayText: '90–100% more Monster Life', tradePatterns: [{ text: "#% more Monster Life", statId: 'explicit.stat_95249895', value: { min: 90, max: 100 } }], category: 'nightmare', familyId: 'monster_life' },
  { id: 'brick_suppression_nightmare', label: 'Monsters Suppress Spell Damage Chance', displayText: 'Monsters have +100% chance to Suppress Spell Damage', tradePatterns: [{ text: "Monsters have +#% chance to Suppress Spell Damage", statId: 'explicit.stat_2138205941', value: { min: 100, max: 100 } }], category: 'nightmare', familyId: 'spell_suppression' },
  { id: 'brick_buff_expiry_nightmare', label: 'Buffs on Players Expire Faster', displayText: 'Buffs on Players expire 100% faster', tradePatterns: [{ text: "Buffs on Players expire #% faster", statId: 'explicit.stat_1217583941', value: { min: 100, max: 100 } }], category: 'nightmare', familyId: 'buff_expiry' },
