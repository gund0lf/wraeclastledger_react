...
export function resolveAutoUpdatePolicy(runtime: AutoUpdateRuntime): AutoUpdatePolicy {
  ...
  // electron-updater's Linux updater requires the APPIMAGE environment variable.
  // Refuse extracted/unpacked Linux builds rather than advertising an update that
  // cannot replace the running executable.
