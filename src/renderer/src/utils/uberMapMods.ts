 ...
 *
 * NOTE: Stash regex tokens for these mods live in modTokens.ts (single source of truth).
 * This file only provides keyword-based clipboard detection + quant/rarity/pack metadata.
 */
