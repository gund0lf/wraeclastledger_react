...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Loot artwork now recognizes exact and decorated identities consistently in imported and manual rows, including current Astrolabes, beasts, uniques, gems, invitations, the Allflame tier-16 map, and a neutral official-CDN Blueprint. Missing artwork still falls back to an honest category symbol, and the custom-loot form explains League versus Other.',
    ],
  },
  {
    version: '1.0.78',
