...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      'Opening and editing a session preserves its starting state. A contextual Undo action and bounded Version history show field changes expanded by default, let you hide individual change lists, keep older compatible checkpoints readable, and restore non-destructively by preserving the state being replaced first.',
  ...
  },
  {
    ...
    changes: [
      ...
      'An optional Run Statistics panel records local Starfall, Svalinn, Wildwood, named Atlas-anomaly, and Mercenary archetype counts. Its five sections start collapsed; Session remains editable while All sessions combines explicitly reported rates and beast gains across saved runs without double-counting the active session. The panel and Bestiary notices can be dismissed per session, Svalinn is shown as a Starfall Crater outcome, and setup-specific Atlas/scarab estimates remain in Session view. The panel stays out of the default layout and Discord shares.',
  ...
  },
  {
    ...
    changes: [
      ...
      'Linux releases can now ship as an x86_64 AppImage with automatic updates and focused-game map capture through a bundled Proton clipboard helper; bridge status and a manual-Paste fallback are shown directly in Map Log.',
    ],
  },
  {
    version: '1.0.75',
