...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      'Pooled strategies show their run and map counts as a visible trust signal, label pooled profit as historical, and expose a paginated per-run breakdown with each run\'s capture time, divine-price snapshot, duration, and game-data provenance.',
