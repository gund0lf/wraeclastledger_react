...
export const SCARAB_LIST: string[] = [
  ...
  // ── Heist ──
  "Heist Scarab",
  "Heist Scarab of Lockpicking",
  "Heist Scarab of Many Clients",
  "Heist Scarab of the Wealthy",
  // ── Incursion ──
  "Incursion Scarab",
...
export const CHISEL_TYPES: Record<string, { label: string; statKey: string; bonusAt20: number }> = {
  Cartographer:  { label: "Cartographer — +10% Quantity",   statKey: "quantity",     bonusAt20: 10  },
  Avarice:       { label: "Avarice — +50% more Currency",   statKey: "moreCurrency", bonusAt20: 50  },
  Procurement:   { label: "Procurement — +40% Rarity",      statKey: "rarity",       bonusAt20: 40  },
  Proliferation: { label: "Proliferation — +10% Pack Size", statKey: "packSize",     bonusAt20: 10  },
