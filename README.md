...
- **Sessions** — integrity-checked local file auto-save, side-by-side comparison of 2-3 saved sessions, and portable JSON export/import. The Sessions panel shows save status and repository size and can open the complete local data folder for backup. Panels are draggable and the layout persists there too.
